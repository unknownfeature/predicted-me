...
class PmApiStack(Stack):
    ...
    def _create_api_function_with_db_params(self, db_stack: PmDbStack, vpc_stack: PmVpcStack,
        ...
        return FunctionFactoryParams(
            ...
            environment={
                            processing_topic_arn: processing_stack.processing_topic.topic_arn if processing_stack else '',
                            text_topic_arn: text_stack.text_topic.topic_arn if text_stack else '',
